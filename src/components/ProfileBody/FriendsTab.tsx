...
const FriendsTab: React.FC<Props> = ({ id }) => {
  ...
  return (
    <Box w={{ base: "100%", lg: "876px" }} mt="16px" bg="secondary" borderRadius="8px">
      <Box m="20px">
        <Text fontSize="24px" fontWeight="bold">Friends</Text>
      </Box>
      <Box mx="auto">
      ...
      {
          !data?.getUserFriendRequests.hasMore && <Text textAlign="center" fontSize="24px" fontWeight="bold">No more friends to show</Text>
      }
      </Box>
    </Box>
  );
